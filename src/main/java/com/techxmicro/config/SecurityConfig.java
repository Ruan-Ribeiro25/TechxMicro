...
import com.techxmicro.service.impl.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                // Liberação de recursos estáticos e essenciais para a Recepção
                .requestMatchers("/css/**", "/js/**", "/uploads/**", "/img/**", "/webjars/**", "/fragments/**", "/manifest.json", "/sw.js", "/favicon.ico").permitAll()
                .requestMatchers("/actuator/**").permitAll()
                // A rota "/" agora é a Recepção Institucional TechxMicro
                ...
                // Regras de Autorização por Perfil (Hierarquia TechxMicro)
            ...
            .logout(logout -> logout
                ...
                .logoutSuccessUrl("/?logout") // Redireciona para a recepção após logout
                .permitAll()
            )
